...
Rectangle {
    ...
    Item {
        ...
        Row {
            ...
            Image {
                source: SiYi.hideWidgets ? using1080p ? "/qml/resources/SiYi/NavGreen.svg" : "/qml/resources/SiYi/NavRed.svg" : "/qml/resources/SiYi/nav.svg"
            ...
            Image {
                ...
                sourceSize.width: btText.width * iconScale
                sourceSize.height: btText.width * iconScale
                source: camera.aiModeOn ? (camera.isTracking ? "/qml/resources/SiYi/AiRed.svg" : "/qml/resources/SiYi/AiGreen.svg") : (aiControlMouseArea.pressed ? "/qml/resources/SiYi/AiGreen.svg" : "/qml/resources/SiYi/Ai.svg")
                //source: aiControl.step === 0 ? "/qml/resources/SiYi/Ai.svg" : (aiControl.step === 1 ? "/qml/resources/SiYi/AiGreen.svg" : "/qml/resources/SiYi/AiRed.svg")
                fillMode: Image.PreserveAspectFit
                cache: false
                anchors.verticalCenter: parent.verticalCenter
            ...
            Image {
                ...
                source: {
                    if (laserDistanceMouseArea.pressed) {
                        return "/qml/resources/SiYi/LaserDistanceGreen.svg"
                    }
                    ...
                    if (camera.laserStateHasResponse) {
                        if (camera.laserStateOn) {
                            ...
                            return "/qml/resources/SiYi/LaserDistance.svg"
                        }
                    } else {
        ...
        Column {
            ...
            spacing: 16
            Image {
                source: "/qml/resources/SiYi/buttonRight.svg"
                fillMode: Image.PreserveAspectFit
                sourceSize.width: btText.width * iconScale
                sourceSize.height: btText.width * iconScale
            ...
            Image {
                ...
                sourceSize.width: btText.width * iconScale
                sourceSize.height: btText.width * iconScale
                source: zoomInMA.pressed ? "/qml/resources/SiYi/ZoomInGreen.svg" : "/qml/resources/SiYi/ZoomIn.svg"
                //anchors.verticalCenter: parent.verticalCenter
            ...
            Image {
                ...
                sourceSize.width: btText.width * iconScale
                sourceSize.height: btText.width * iconScale
                source: zoomOutMA.pressed ? "/qml/resources/SiYi/ZoomOutGreen.svg" : "/qml/resources/SiYi/ZoomOut.svg"
                //anchors.verticalCenter: parent.verticalCenter
                anchors.horizontalCenter: parent.horizontalCenter
                fillMode: Image.PreserveAspectFit
                cache: false
            ...
            Image {
                ...
                sourceSize.width: btText.width * iconScale
                sourceSize.height: btText.width * iconScale
                source: resetMA.pressed ? "/qml/resources/SiYi/ResetGreen.svg" : "/qml/resources/SiYi/Reset.svg"
                //anchors.verticalCenter: parent.verticalCenter
                anchors.horizontalCenter: parent.horizontalCenter
                fillMode: Image.PreserveAspectFit
                cache: false
            ...
            Image {
                ...
                sourceSize.width: btText.width * iconScale
                sourceSize.height: btText.width * iconScale
                source: photoMA.pressed ? "/qml/resources/SiYi/PhotoGreen.svg" : "/qml/resources/SiYi/Photo.svg"
                //anchors.verticalCenter: parent.verticalCenter
                anchors.horizontalCenter: parent.horizontalCenter
                fillMode: Image.PreserveAspectFit
                cache: false
            ...
            Image {
                ...
                Connections {
                    ...
                    function onEnableVideoChanged() {
                        video.source = "/qml/resources/SiYi/empty.png"
                        if (camera.enableVideo) {
                            if (camera.isRecording) {
                                video.source = "/qml/resources/SiYi/Stop.svg"
                            } else {
                                video.source = "/qml/resources/SiYi/Video.png"
                            }
                        }
                    }
            ...
            Image {
                ...
                sourceSize.width: btText.width * iconScale
                sourceSize.height: btText.width * iconScale
                source: farMA.pressed ? "/qml/resources/SiYi/farGreen.svg" : "/qml/resources/SiYi/far.svg"
                //anchors.verticalCenter: parent.verticalCenter
                anchors.horizontalCenter: parent.horizontalCenter
                fillMode: Image.PreserveAspectFit
                cache: false
            ...
            Image {
                ...
                sourceSize.width: btText.width * iconScale
                sourceSize.height: btText.width * iconScale
                source: neerMA.pressed ? "/qml/resources/SiYi/neerGreen.svg" : "/qml/resources/SiYi/neer.svg"
                //anchors.verticalCenter: parent.verticalCenter
                anchors.horizontalCenter: parent.horizontalCenter
                fillMode: Image.PreserveAspectFit
                cache: false
